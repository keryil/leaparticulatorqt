...
setup(
        ...
        packages=['qt_generated', 'leaparticulator', 'leaparticulator.p2p', 'leaparticulator.p2p.ui',
                  'leaparticulator.data', 'leaparticulator.test', 'leaparticulator.test.p2p',
                  'leaparticulator.test.data',
                  'leaparticulator.test.analysis', 'leaparticulator.test.benchmark',
                  'leaparticulator.test.benchmark.data',
